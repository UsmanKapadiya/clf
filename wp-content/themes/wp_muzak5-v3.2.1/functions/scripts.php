...
function ci_register_theme_scripts()
{
	...
	wp_register_script('prettyPhoto', 			get_template_directory_uri().'/js/jquery.prettyPhoto.min.js', array( 'jquery' ), '3.1.5', true );
	...
	wp_register_script('transition', get_child_or_parent_file_uri('/js/transition.js'), array('jquery'), false, true);
	wp_register_script('collapse', get_child_or_parent_file_uri('/js/collapse.js'), array('jquery'), false, true);
